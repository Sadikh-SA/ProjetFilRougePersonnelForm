 ...
 */
final class Version20190813193334 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD date_envoie DATETIME NOT NULL, ADD date_retrait DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction DROP date_envoie, DROP date_retrait');
