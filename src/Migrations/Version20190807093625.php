 ...
 */
final class Version20190807093625 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depot ADD compte_id INT NOT NULL, ADD caissier_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE utilisateur ADD partenaire_id INT DEFAULT NULL, ADD compte_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depot DROP compte_id, DROP caissier_id');
